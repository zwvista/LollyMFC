...
{
	lf.lfHeight=_ttol((LPCTSTR)GetToken(str, _T(",")));
	lf.lfWidth=_ttol((LPCTSTR)GetToken(str, _T(",")));
	lf.lfEscapement=_ttol((LPCTSTR)GetToken(str, _T(",")));
	lf.lfOrientation=_ttol((LPCTSTR)GetToken(str, _T(",")));
	lf.lfWeight=_ttol((LPCTSTR)GetToken(str, _T(",")));
	lf.lfItalic=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	lf.lfUnderline=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	lf.lfStrikeOut=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	lf.lfCharSet=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	lf.lfOutPrecision=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	lf.lfClipPrecision=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	lf.lfQuality=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	lf.lfPitchAndFamily=_ttoi((LPCTSTR)GetToken(str, _T(",")));
	_tcscpy(lf.lfFaceName, (LPCTSTR)GetToken(str, _T(",")));

	DeleteObject();
	CreateFontIndirect(&lf);

	fontColor=_ttol((LPCTSTR)str);
}
