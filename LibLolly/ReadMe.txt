========================================================================
    STATIC LIBRARY : DllLolly Project Overview
========================================================================

AppWizard has created this DllLolly library project for you.

This file contains a summary of what you will find in each of the files that
make up your DllLolly application.
...
StdAfx.h, StdAfx.cpp
    ...
    named DllLolly.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "DllLolly.rc" and a "DllLolly.h" that
