...
public:
	...
	int		SetCornerDefault(CUGCell *cell);
	int		GetCornerDefault(CUGCell *cell);
	int		SetTopHeadingDefault(CUGCell *cell);
	int		GetTopHeadingDefault(CUGCell *cell);
	int		SetSideHeadingDefault(CUGCell *cell);
	int		GetSideHeadingDefault(CUGCell *cell);
	...
	static void TrackMouseEvent(HWND hwnd);
