...
CUGGridInfo::CUGGridInfo()
{
	...
	m_cnrDefaults  = new CUGCell;
	m_cnrDefaults->SetBackColor(GetSysColor(COLOR_BTNFACE));
	m_cnrDefaults->SetBorder(UG_BDR_RAISED);
	m_cnrDefaults->SetAlignment(UG_ALIGNCENTER|UG_ALIGNVCENTER);
	m_cnrDefaults->SetXPStyle(XPCellTypeBorder);
	m_sideHdgDefaults  = new CUGCell;
	m_sideHdgDefaults->SetBackColor(GetSysColor(COLOR_BTNFACE));
	m_sideHdgDefaults->SetBorder(UG_BDR_RAISED);
	m_sideHdgDefaults->SetAlignment(UG_ALIGNCENTER|UG_ALIGNVCENTER);
	m_sideHdgDefaults->SetXPStyle(XPCellTypeBorder);
	m_topHdgDefaults  = new CUGCell;
	m_topHdgDefaults->SetBackColor(GetSysColor(COLOR_BTNFACE));
	m_topHdgDefaults->SetBorder(UG_BDR_RAISED);
	m_topHdgDefaults->SetAlignment(UG_ALIGNCENTER|UG_ALIGNVCENTER);
	m_topHdgDefaults->SetXPStyle(XPCellTypeBorder);
...
CUGGridInfo::~CUGGridInfo()
{
	...
	if(m_cnrDefaults != NULL)
		delete m_cnrDefaults;
	if(m_sideHdgDefaults != NULL)
		delete m_sideHdgDefaults;
	if(m_topHdgDefaults != NULL)
		delete m_topHdgDefaults;
