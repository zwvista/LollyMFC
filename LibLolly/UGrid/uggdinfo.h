...
public:
	...
	CUGCell *	m_cnrDefaults;
	CUGCell *	m_sideHdgDefaults;
	CUGCell *	m_topHdgDefaults;
	...
	int m_gridWidth;		//calculated using the values above
	int m_gridHeight;

	RECT	m_gridRect;		//calculated using the values above
	RECT	m_topHdgRect;
	RECT	m_sideHdgRect;
	RECT	m_cnrBtnRect;
	RECT	m_tabRect;
	...
	long m_hoverRow;
	int m_hoverCol;
	int m_hoverState; // 0-left button up inside 
	                  // 1-left button down outside 2-left button down inside

	int m_editMode; // 0-edit on enter 1-edit on keystroke
};
